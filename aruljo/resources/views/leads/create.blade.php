     ...
     <div class="max-w-4xl mx-auto bg-white shadow-md rounded-xl p-6">
        ...
        <form action="{{ route('leads.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="platform" class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" required>
                        ...
                        <option value="India Mart">Others</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="buyer_contact" class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
            ...
            <div class="text-center pt-4">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-xl text-base transition duration-200">
                    Submit
                </button>
            </div>
        </form>
